...
sun2.to("#lg4 stop:nth-child(1)", { attr: { "stop-color": "#ffb037" } }, 0)
sun2.to("#lg4 stop:nth-child(2)", { attr: { "stop-color": "#261F36" } }, 0)
sun2.to("#bg_grad stop:nth-child(3)", { attr: { "stop-color": "#ffb037" } }, 0)
sun2.to("#bg_grad2 stop:nth-child(6)", { attr: { "stop-color": "#AB3760" } }, 0)
sun2.to("#bg_grad2 stop:nth-child(4)", { attr: { "stop-color": "#64205E" } }, 0)
sun2.to("#bg_grad2 stop:nth-child(5)", { attr: { "stop-color": "#F68B4F" } }, 0)
...
stars.to("#bg_grad", { attr: { cy: "730" } }, 0.00)
stars.to("#bg_grad stop:nth-child(3)", { attr: { "stop-color": "#ffb037" } }, 0)
stars.to("#bg_grad2 stop:nth-child(6)", { attr: { "stop-color": "" } }, 0)
sun2.to("#bg_grad2 stop:nth-child(4)", { attr: { "stop-color": "#64205E" } }, 0)
sun2.to("#bg_grad2 stop:nth-child(5)", { attr: { "stop-color": "#F68B4F" } }, 0)
//bg change
...
sun2.to("#bg_grad2 stop:nth-child(4)", { attr: { "stop-color": "#64205E" } }, 0)
sun2.to("#bg_grad2 stop:nth-child(5)", { attr: { "stop-color": "#F68B4F" } }, 0)
sceneTransition.fromTo("#stars", { opacity: 0 }, { opacity: 1, y: -900 }, 0)
sceneTransition.to("#h2-1", { y: -1250, scale: 1.5, transformOrigin: "50% 50%" }, 0)
...
scene3.fromTo("#h3-6", { y: 1000 }, { y: -550 }, 0.12)
scene3.fromTo("#h3-7", { y: 400 }, { y: -10 }, 0.12)
scene3.fromTo("#coconerd", { y: 1000 }, { y: -10 }, 0.12)
